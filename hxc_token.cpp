...
#include "hxc_token.hpp"

void hxctoken::create( account_name issuer,
...
void hxctoken::issue( account_name to, asset quantity, string memo )
{
...
void hxctoken::transfer( account_name from,
                      account_name to,
                      asset        quantity,
                      string       memo )
{
...
void hxctoken::sub_balance( account_name owner, asset value ) {
...
void hxctoken::add_balance( account_name owner, asset value, account_name ram_payer )
{
...
EOSIO_ABI( hxctoken, (create)(issue)(transfer) )
